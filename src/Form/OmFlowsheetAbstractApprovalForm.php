...
/**
 * @file
 * Contains \Drupal\om_flowsheet\Form\OmFlowsheetAbstractApprovalForm.
 */
...
class OmFlowsheetAbstractApprovalForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'om_flowsheet_abstract_approval_form';
  }

  public function buildForm(array $form, \Drupal\Core\Form\FormStateInterface $form_state) {
    $solution_id = (int) arg(4);
